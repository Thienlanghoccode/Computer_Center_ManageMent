...
public class QuanLyTaiKhoan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tblDanhSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã nhân viên", "Tên đăng nhập", "Mật khẩu", "Là Admin"
            }
        ) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (quyenTruyCap.equalsIgnoreCase("User")) {
            isAdmin = false;
        } else {
            isAdmin = true;
        }
        try {
            if (checkMaNV()) {
                TaiKhoan tk = new TaiKhoan(maNV, user, password, isAdmin);
    ...
    private void tblDanhSachMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDanhSachMouseClicked
        ...
        if (row >= 0) {
            ...
            if (tk.isIsAdmin() == true) {
                cbQuyenTruyCap.setSelectedItem("Admin");
            } else {
                cbQuyenTruyCap.setSelectedItem("User");
            }
