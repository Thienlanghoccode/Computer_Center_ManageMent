...
public class ThongKeDoanhSoDao {
    ...
    public static List<ChiTietHoaDon> getData() {
        ...
        try {
            String sql
                    = "select ChiTietHoaDon.maHD, HoaDon.maNV,tenNV, tenKH, ngayLap, sum(soLuongBan * donGia) as 'thanhTien'\n"
            ...
            while (rs.next()) {
                ...
                ChiTietHoaDon ct = new ChiTietHoaDon(rs.getString("maHD"),
                        rs.getString("maNV"), rs.getString("tenNV"),
                        rs.getString("tenKH"), dinhDangMoi.format(date),
            ...
            Logger.getLogger(ThongKeDoanhSoDao.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            if (pre != null) {
                try {
                    pre.close();
